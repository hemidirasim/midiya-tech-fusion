...
const Hero = () => {
  ...
  return <section ref={ref} className="relative overflow-hidden">
      ...
      <div aria-hidden className="absolute inset-0 -z-10 pointer-events-none">
        <div className="absolute -top-24 -left-24 h-72 w-72 rounded-full blur-3xl opacity-40" style={{
        background: "radial-gradient(closest-side, hsl(var(--brand)/0.6), transparent)"
      }} />
        <div className="absolute -bottom-24 -right-24 h-80 w-80 rounded-full blur-3xl opacity-40" style={{
        background: "radial-gradient(closest-side, hsl(var(--brand-2)/0.6), transparent)"
      }} />
      </div>
