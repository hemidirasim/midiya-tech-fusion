...
const translations: Record<Lang, Dict> = {
  en: {
    ...
    hero: {
      ...
      logoAlt: "Midiya — technology solutions",
    },
    services: {
    ...
    quoteForm: {
      ...
      successDesc: "We have received your request and will contact you soon.",
  ...
  az: {
    ...
    quoteForm: {
      ...
      sending: "Göndərilir...",
      successTitle: "Mesaj uğurla göndərildi",
      successDesc: "Sorğunuzu aldıq və tezliklə sizinlə əlaqə saxlayacağıq.",
