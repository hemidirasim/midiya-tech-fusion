  ...
  en: {
    ...
    faq: {
      ...
      items: [
        {
          q: "Why Midiya?",
          a: "End‑to‑end services: design, development, production, and support. Software and hardware together.",
        },
        {
          q: "How long does delivery take?",
          a: "Depends on scope. MVP in 2‑6 weeks; phased planning for complex systems.",
        },
        {
          q: "How do you integrate AI solutions?",
          a: "Model selection for your infrastructure, API/edge integration, and protection of private data.",
        },
      ],
    },
    footer: {
